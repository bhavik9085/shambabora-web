...
const AddEditDistrict = ({
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      dispatch(
        addAlert({
          message: mode === 'edit' ? 'District updated successfully!' : 'District added successfully!',
  ...
  return (
    <Dialog open={true} onOpenChange={handleCancel}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{mode === 'edit' ? 'Edit District' : 'Add District'}</DialogTitle>
          <DialogDescription>
            {mode === 'edit' ? 'Update the District details.' : 'Enter the District details.'}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className='grid gap-4'>
              ...
              <div className='flex justify-end space-x-2'>
                ...
                >
                  {mode === 'edit' ? 'Update District' : 'Create District'}
                </Button>
